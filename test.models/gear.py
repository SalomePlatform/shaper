...
Sketch_4 = model.addSketch(Part_1_doc, model.selection("FACE", "_weak_name_1_Revolution_1_1"))
...
model.do()
ExtrusionCut_1 = model.addExtrusionCut(Part_1_doc, [model.selection("COMPOUND", "Sketch_1")], model.selection(), model.selection("FACE", "_weak_name_5_Revolution_1_1"), 0, model.selection(), 0, [model.selection("SOLID", "Revolution_1_1")])
