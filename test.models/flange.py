...
SketchConstraintRadius_2.setName("SketchConstraintRadius_5")
model.do()
...
SketchLine_11 = Sketch_2.addLine(0, 78.00705060867459, 0, 133.9929493913254)
SketchConstraintCoincidence_15 = Sketch_2.setCoincident(SketchArc_9.startPoint(), SketchLine_11.startPoint())
SketchConstraintCoincidence_16 = Sketch_2.setCoincident(SketchArc_9.endPoint(), SketchLine_11.endPoint())
model.do()
...
SketchConstraintCoincidence_18 = Sketch_3.setCoincident(SketchLine_12.startPoint(), SketchLine_14.result())
...
SketchConstraintCoincidence_19 = Sketch_3.setCoincident(SketchLine_14.result(), SketchArc_10.center())
SketchConstraintRadius_4 = Sketch_3.setRadius(SketchArc_10.results()[1], "15/2")
SketchConstraintRadius_4.setName("SketchConstraintRadius_6")
...
SketchConstraintCoincidence_20 = Sketch_3.setCoincident(SketchLine_13.endPoint(), SketchArc_10.startPoint())
...
SketchConstraintCoincidence_21 = Sketch_3.setCoincident(SketchArc_10.endPoint(), SketchLine_16.result())
...
SketchConstraintCoincidence_22 = Sketch_4.setCoincident(SketchPoint_3.coordinates(), SketchLine_19.result())
...
SketchConstraintCoincidence_23 = Sketch_4.setCoincident(SketchLine_18.startPoint(), SketchArc_11.center())
...
SketchConstraintCoincidence_24 = Sketch_4.setCoincident(SketchLine_18.endPoint(), SketchArc_12.center())
...
SketchConstraintRadius_5.setName("SketchConstraintRadius_7")
SketchLine_20 = Sketch_4.addLine(-71, 16, -71, -16)
SketchLine_20.setName("SketchLine_21")
SketchLine_20.result().setName("SketchLine_21")
SketchConstraintCoincidence_25 = Sketch_4.setCoincident(SketchArc_11.endPoint(), SketchLine_20.startPoint())
SketchConstraintCoincidence_25.setName("SketchConstraintCoincidence_26")
SketchConstraintCoincidence_26 = Sketch_4.setCoincident(SketchArc_12.endPoint(), SketchLine_20.endPoint())
...
SketchConstraintCoincidence_27 = Sketch_4.setCoincident(SketchArc_11.startPoint(), SketchLine_21.startPoint())
SketchConstraintCoincidence_27.setName("SketchConstraintCoincidence_28")
SketchConstraintCoincidence_28 = Sketch_4.setCoincident(SketchArc_12.startPoint(), SketchLine_21.endPoint())
