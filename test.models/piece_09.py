...
SketchConstraintEqual_7 = Sketch_1.setEqual(SketchArc_6.results()[1], SketchArc_7.results()[1])
SketchConstraintEqual_8 = Sketch_1.setEqual(SketchLine_7.result(), SketchLine_13.result())
...
#SketchConstraintCoincidence_36 = Sketch_2.setCoincident(SketchAPI_Line(SketchLine_15).startPoint(), SketchLine_22.endPoint())
SketchLine_23 = Sketch_2.addLine(-24.99999999999999, -35.00000000000001, -24.99999999999999, -32.50000000000002)
SketchConstraintCoincidence_37 = Sketch_2.setCoincident(SketchAPI_Line(SketchLine_14).endPoint(), SketchLine_23.startPoint())
#SketchConstraintCoincidence_38 = Sketch_2.setCoincident(SketchAPI_Line(SketchLine_15).startPoint(), SketchLine_23.endPoint())
SketchConstraintCoincidence_38 = Sketch_2.setCoincident(SketchLine_22.endPoint(), SketchLine_23.endPoint())
...
#SketchConstraintDistance_11 = Sketch_2.setDistance(SketchLine_16.result(), SketchPoint_2.coordinates(), "(h4-d_diff)*coeff")
SketchConstraintDistance_12 = Sketch_2.setDistance(SketchPoint_2.coordinates(), SketchLine_17.result(), "e3*coeff")
#SketchConstraintCoincidence_40 = Sketch_2.setCoincident(SketchLine_16.startPoint(), SketchLine_15.result())
...
SketchLine_50 = Sketch_6.addLine(model.selection("EDGE", "Sketch_1/Edge-SketchLine_10"))
